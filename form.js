...
const list = [
  { text: "i~&__", code: "\u1472", name: 'Nasal German i with extra low tone' },
  { text: "i~&_", code: "\u1464", name: 'Nasal German i with low tone' },
  { text: "i~&^^", code: "\u1460", name: 'Nasal German i with extra high tone' },
  { text: "i~&^", code: "\u146c", name: 'Nasal German i with high tone' },
  { text: "i~&", code: "\u1468", name: 'Nasal German i' },
  { text: "(i~&__)", code: "\u1473", name: 'Nasal German i with extra low tone and stress' },
  { text: "(i~&_)", code: "\u1465", name: 'Nasal German i with low tone and stress' },
  { text: "(i~&^^)", code: "\u1461", name: 'Nasal German i with extra high tone and stress' },
  { text: "(i~&^)", code: "\u146d", name: 'Nasal German i with high tone and stress' },
  { text: "(i~&)", code: "\u1469", name: 'Nasal German i with stress' },

  { text: "i~__", code: "\u1478", name: 'German i with extra low tone' },
  { text: "i~_", code: "\u03d6", name: 'German i with low tone' },
  { text: "i~^^", code: "\u147c", name: 'German i with extra high tone' },
  { text: "i~^", code: "\u03da", name: 'German i with high tone' },
  { text: "i~", code: "\u03d1", name: 'German i' },
  { text: "(i~__)", code: "\u1479", name: 'German i with extra low tone and stress' },
  { text: "(i~_)", code: "\u03d7", name: 'German i with low tone and stress' },
  { text: "(i~^^)", code: "\u147d", name: 'German i with extra high tone and stress' },
  { text: "(i~^)", code: "\u03db", name: 'German i with high tone and stress' },
  { text: "(i~)", code: "\u03d3", name: 'German i with stress' },
  ...
  { text: "u~&__", code: "\u14f0", name: 'Nasal English r with extra low tone' },
  { text: "u~&_", code: "\u14e2", name: 'Nasal English r with low tone' },
  { text: "u~&^^", code: "\u14ee", name: 'Nasal English r with extra high tone' },
  { text: "u~&^", code: "\u14ea", name: 'Nasal English r with high tone' },
  { text: "u~&", code: "\u14e6", name: 'Nasal English r' },
  { text: "(u~&__)", code: "\u14f1", name: 'Nasal English r with extra low tone and stress' },
  { text: "(u~&_)", code: "\u14e3", name: 'Nasal English r with low tone and stress' },
  { text: "(u~&^^)", code: "\u14ef", name: 'Nasal English r with extra high tone and stress' },
  { text: "(u~&^)", code: "\u14eb", name: 'Nasal English r with high tone and stress' },
  { text: "(u~&)", code: "\u14e7", name: 'Nasal English r with stress' },

  { text: "u~__", code: "\u14fa", name: 'English r with extra low tone' },
  { text: "u~_", code: "\u0434", name: 'English r with low tone' },
  { text: "u~^^", code: "\u14fe", name: 'English r with extra high tone' },
  { text: "u~^", code: "\u0438", name: 'English r with high tone' },
  { text: "u~", code: "\u0430", name: 'English r' },
  { text: "(u~__)", code: "\u14fb", name: 'English r with extra low tone and stress' },
  { text: "(u~_)", code: "\u0435", name: 'English r with low tone and stress' },
  { text: "(u~^^)", code: "\u14ff", name: 'English r with extra high tone and stress' },
  { text: "(u~^)", code: "\u0439", name: 'English r with high tone and stress' },
  { text: "(u~)", code: "\u0432", name: 'English r with stress' },
  ...
  { text: "s+!", code: "\u007d", name: 'Navajo ls sound ejective' },
  { text: "s!", code: "\u007c", name: 'Navajo s sound ejective' },
  ...
  { text: "x!", code: "\u019c", name: 'Ejective sh sound' },
  ...
  { text: "w+", code: "\u0112", name: 'Welsh w sound' },
